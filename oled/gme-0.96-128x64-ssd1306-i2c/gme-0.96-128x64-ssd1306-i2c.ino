...
U8G2_SSD1306_128X64_NONAME_1_HW_I2C u8g2(U8G2_R0);//page buffer mode  //U8G2_SSD1306_128X64_NONAME_1_HW_I2C(rotation, [reset [, clock, data]]) [page buffer, size = 128 bytes]
...
//    u8g2.setDrawColor(2);//0 (clear pixel value in the display RAM), 1 (set pixel value) or 2 (XOR mode)
    ...
    u8g2.drawLine(128, 0, 0, 64);
    u8g2.drawCircle(108, 20, 15, U8G2_DRAW_ALL);
    u8g2.drawBox(64,32,128,64);
