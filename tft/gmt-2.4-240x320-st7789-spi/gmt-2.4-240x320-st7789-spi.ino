...
void blinkScreenCorner(){
  //mark screen corner
  tft.fillRect(0,0,2,2,ST77XX_WHITE);
  tft.fillRect(238,0,2,2,ST77XX_WHITE);
  tft.fillRect(0,318,2,2,ST77XX_WHITE);
  tft.fillRect(238,318,2,2,ST77XX_WHITE);
  delay(500);
  tft.fillRect(0,0,2,2,ST77XX_RED);
  tft.fillRect(238,0,2,2,ST77XX_RED);
  tft.fillRect(0,318,2,2,ST77XX_RED);
  tft.fillRect(238,318,2,2,ST77XX_RED);
  delay(500);
}
