...
//for GMT130-v1.0:
  ...
  //金逸晨 0.96-8pin13p_ips
  // tft.initR(INITR_MINI160x80_GMT);
...
void blinkScreenCorner(){
  //mark screen corner
  tft.drawPixel(0,0,ST77XX_WHITE);
  // tft.drawPixel(79,0,ST77XX_WHITE);
  tft.drawPixel(239,0,ST77XX_WHITE);
  // tft.drawPixel(79,159,ST77XX_WHITE);
  // tft.drawPixel(0,79,ST77XX_WHITE);
  tft.drawPixel(0,239,ST77XX_WHITE);
  tft.drawPixel(239,239,ST77XX_WHITE);
  delay(500);
  tft.drawPixel(0,0,ST77XX_RED);
  // tft.drawPixel(79,0,ST77XX_RED);
  tft.drawPixel(239,0,ST77XX_RED);
  // tft.drawPixel(79,159,ST77XX_RED);
  // tft.drawPixel(0,79,ST77XX_RED);
  tft.drawPixel(0,239,ST77XX_RED);
  tft.drawPixel(239,239,ST77XX_RED);
  delay(500);
}
